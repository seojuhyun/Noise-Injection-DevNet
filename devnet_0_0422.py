...
def plot_mean_roc_pr(y_tests, y_scores, output_dir="./"):
    ...
    plt.title('Baseline Average ROC Curve')
    plt.legend()
    plt.grid(True)
    ...
    plt.title('Baseline Average Precision-Recall Curve')
    plt.legend()
    plt.grid(True)
...
def save_results(dataset_name, script_name, auc_roc, auc_pr, f1, output_file="results_10R_00.csv"):
    """
