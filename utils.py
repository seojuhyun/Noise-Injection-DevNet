...
def writeResults(filename, total_samples, total_features, train_samples, original_outliers, remaining_outliers,
                 network_depth, mean_auc, mean_aucpr, std_auc, std_aucpr, train_time, test_time, path):
    file_path = os.path.join(path, "results.csv")  # ✅ 파일 이름 추가
